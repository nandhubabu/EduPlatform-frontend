...
const fetchPersonalizedRecommendations = async () => {
  const response = await fetch("/api/v1/courses/recommendations/personalized", {
    headers: {
...
const CourseCard = ({ course, isRecommended = false, onEnroll }) => {
...
const Courses = () => {
  ...
  const handleEnrollment = async (courseId) => {
    ...
    try {
      ...
      setEnrollmentMessage(error.message || "Enrollment failed. Please try again.");
    }
